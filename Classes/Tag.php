    ...
    public function __construct($url){
      $this->_url=$url;
		...
		private function createFooterJS($js=""){
			...
			$tag="
				...
				<script src='".$url."js/piechart.js'></script>
				<script src='".$url."js/toggleHide.js'></script>
				$scripts
			";
			return $tag;
		}
      ...
      ;
			...
			if($email){
				...
				$allReveiwMenu = [
					"New Review" => ['url'=>'review-vendor', 'fa'=>'check-circle', 'sub'=>[]],
					"My Review" => ['url'=>'review-vendor-mine', 'fa'=>'check-circle-o', 'sub'=>[]]
					];
				$allStaffMenu = "";
				switch ($userDetails['authority']) {
					...
					case 'vendor':
						$userMenu = [
							...
							'Review Status' => ['url'=>'vendor-review-status', 'fa'=>'hospital-o', 'sub'=>[]],
					...
					break;
					case 'review officer':
						$userMenu = $allReveiwMenu;
						
					break;
					case 'supervising officer':
						$userMenu = $allReveiwMenu;
						$userMenu['New Audit Report'] = ['url'=>'review-audit', 'fa'=>'file', 'sub'=>[]];
						$userMenu['My Audit Report'] = ['url'=>'review-audit-mine', 'fa'=>'file-o', 'sub'=>[]];
					break;
					...
					case 'audit':
						$userMenu = [
							'Schedule Audit' => ['url'=>'audit-date', 'fa'=>'calendar', 'sub'=>[]],
							'Upload Report' => ['url'=>'audit-report-list', 'fa'=>'upload', 'sub'=>[]],
							'My Uploads' => ['url'=>'audit-my-report-list', 'fa'=>'files-o', 'sub'=>[]],
							'Rejected Uploads' => ['url'=>'audit-rejected-report', 'fa'=>'question-circle', 'sub'=>[]]
						];
					break;
				}
		...
		/**
		 * Create the menu bar for questionnaire review
		 * @param integer $vendorID the vendor id
		 * @param integer $reviewID the review id
		 * @return string $tag HTML tags that represent the menu
		 */
		public function reviewMenu($vendorID, $reviewID){
			$tag ="
				  ...
				  <div class='x_panel'>
				    ...
				    <div class='x_content'>
				      ...
				      <div class='bs-example-popovers'>
				        <a type='button' class='btn btn-success' href='".URL."view-vendor-general/?vendor=$vendorID&review=$reviewID'>
				          General
				        </a>
				        <a type='button' class='btn btn-success' href='".URL."view-vendor-finance/?vendor=$vendorID&review=$reviewID'>
				          Finance
				        </a>
				        <a type='button' class='btn btn-success' href='".URL."view-vendor-quality-management/?vendor=$vendorID&review=$reviewID'>
				          Quality Management
				        </a>
				        <a type='button' class='btn btn-success' href='".URL."view-vendor-nigeria-content/?vendor=$vendorID&review=$reviewID'>
				          Nigeria Content
				        </a>
				        <a type='button' class='btn btn-success' href='".URL."view-vendor-hse/?vendor=$vendorID&review=$reviewID'>
				          Health and Safety
				        </a>
				        <a type='button' class='btn btn-success' href='".URL."view-vendor-legal/?vendor=$vendorID&review=$reviewID'>
				          Legal
				        </a>
				        <a type='button' class='btn btn-success' href='".URL."view-vendor-personnel/?vendor=$vendorID&review=$reviewID'>
				          Personnel
				        </a>
				        <a type='button' class='btn btn-success' href='".URL."view-vendor-product-services/?vendor=$vendorID&review=$reviewID'>
				          Product Services
				        </a>
				        <a type='button' class='btn btn-success' href='".URL."view-vendor-declaration/?vendor=$vendorID&review=$reviewID'>
				          Declaration
				        </a><br/> <br/>
				        <a type='button' class='btn btn-primary' href='".URL."review-vendor-submission/?vendor=$vendorID&review=$reviewID'>
				          SUBMIT REVIEW
				        </a>
				      </div>
				      <!-- end pop-over -->
