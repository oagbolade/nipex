<?php
	...
	$menu = $Tag->createSideBar($PDO, $userDetails['email'], ['parent'=>'Upload Report', 'child'=>'View Staff']);
	...
	$table ="
      ...
      <tbody>
	";
	if($reviewees = $DbHandle->iRetrieveData(__LINE__, ['audit_date'=>"IS NOT NULL", 'submission_date'=>"IS NULL"])){
		$kanter = 0;
